...
<body>
	...
	<script type="text/javascript">
	 ...
	 <!--blink-->
     <div id="left_sidebar">
    	<img src="images/bird3.png" width="129" height="777"/>
    	<img src="images/bird4.png" width="129" height="777"/>
    </div>
    <div id="right_sidebar">
        <img src="images/bird2.png" width="129" height="777"/>
        <img src="images/bird1.png" width="129" height="777"/>
    </div>	
    <!--end of blink-->
	<div id="container" class="div_750_auto">
        ...
        <div id="nav">
        	...
        	<h1 style="font-size:30px; text-align:center; margin-top:4px;background:url(images/box.png); padding:5px; color:#fff;text-shadow: 2px 2px #999;"> RULES & REGULATION </h1>
